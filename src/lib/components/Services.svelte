<section class="hero min-h-screen bg-[#06070b]" id="services">
  <div class="container px-6 py-10 mx-auto">
    <h2 class="text-center text-clampTitle font-bold pb-6 text-white">
      Ce que nous offrons
    </h2>

    <div class="-mx-4 flex flex-wrap mt-8 xl:mt-12">
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div
          class="mb-9 rounded-[20px] bg-white dark:bg-dark-2 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10"
        >
          <div
            class="bg-gradient mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl"
          >
            <svg
          ...
          <h4 class="text-black mb-[14px] text-2xl font-semibold">
            Idéation et scriptage
          </h4>
          <p class="text-custom-black">
            Conception créative et rédaction de scripts pour captiver et engager
            votre audience.
          </p>
        </div>
      </div>
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        ...
        >
          ...
          <h4 class="text-black mb-[14px] text-2xl font-semibold">Filmage</h4>
          <p class="text-custom-black">
            Captation vidéo de haute qualité pour donner vie à vos visions
            créatives.
          </p>
        </div>
      </div>
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        ...
        >
          ...
          <h4 class="text-black mb-[14px] text-2xl font-semibold">Montage</h4>

          <p class="text-custom-black">
            Montage vidéo professionnel pour transformer vos clips en contenus
            captivants.
          </p>
        </div>
      </div>
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        ...
        >
          ...
          <p class="text-custom-black">
            Optimisation et gestion de vos réseaux sociaux pour maximiser
      ...
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        ...
        >
          ...
          <p class="text-custom-black">
            Gestion efficace de Google Ads pour accroître la visibilité et les
            conversions.
          </p>
        </div>
      </div>
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        ...
        >
          ...
          <h4 class="text-black mb-[14px] text-2xl font-semibold">Meta ads</h4>
          <p class="text-custom-black">
            Stratégies ciblées de Meta Ads pour booster votre présence et
            engagement en ligne.
          </p>
        </div>
      </div>
